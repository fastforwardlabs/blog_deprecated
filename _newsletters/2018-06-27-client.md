...
Hello!  In this week's newsletter, we cover a fun project involving neural reinterpretations of movie trailers, and sequence labeling with semi-supervised multi-task learning.  Speaking of multi-task learning -  we hope you'll join us for our upcoming [webinar](https://info.cloudera.com/LP=2027?elq_id=CCLOU000007199414) on Wednesday, July 11th on **Multi-Task Learning: Stepping away from narrow expert models**.  Also, stay tuned for a new blogpost on this topic, coming later this week! (We'll post the link on [LinkedIn](https://www.linkedin.com/company/fast-forward-labs/) and [Twitter](https://twitter.com/FastForwardLabs) once it's published.)
