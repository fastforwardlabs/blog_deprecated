...
For more on building recommendation systems that can better understand content, be sure check out our new Semantic Recommendations report!  (We'll also be tweeting the link to a webinar we recorded about it, as soon as it's available. [Follow us on Twitter: @fastforwardlabs](https://twitter.com/FastForwardLabs).)
