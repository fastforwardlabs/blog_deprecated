...
One of the most interesting parts of Vancil’s talk comes at the end, where she talks about the possibility of a Twitter-like site where each user can fork and modify the appearance and interface at will. She also talks about each user storing their identity locally (through a JSON file) and thereby maintaining control of their data. That vision of control of your data which services connect to is also the promise of the Berners-Lee’s [Solid](https://solid.inrupt.com/) project. Solid, however, is built on top of the web, rather than being a new protocol.
...
A few last links:
- You can get a feel for the variety of interests involved by looking through the [conference website from the Decentralized Web Summit 2018](https://decentralizedweb.net/). 
