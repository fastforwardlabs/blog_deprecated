...
We are excited to announce that beginning Tuesday, September 5th, we'll be making the individual subscription program open to the public!

As Insight Fellows, now Insight Alumni, you had access to our reports and prototypes, and we shared with you our original-content newsletters. For continued access, we would like to invite you to join our individual subscription program. We recognize that corporate budgets don’t always allow for new offerings and many people interested in machine learning are not necessarily working in the field yet.  This program is one way we can make sure we're helping the data science community learn and grow. If you are interested, email us at contact@fastforwardlabs.com.
