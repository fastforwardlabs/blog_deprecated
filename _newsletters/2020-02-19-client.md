...
One place where I did end up adding more complex animation back in was in the strategy ranking, I used a package called [react-flip-move](https://github.com/joshwcomeau/react-flip-move) to animate changes in the rankings. Seeing the rankings move, rather than just appear immediately in there new spot, makes it much easier to parse what changes are happening.
...
Be sure to try [Blip](https://blip.fastforwardlabs.com) and read more about its making (including the algorithms) and all things deep learning for anomaly detection in [our report](https://ff12.fastforwardlabs.comBe sure to try [Blip](https://blip.fastforwardlabs.com).## Building Blip: behind the scenes of our anomaly detection prototype
