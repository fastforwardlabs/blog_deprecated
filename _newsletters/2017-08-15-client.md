...
In our newsletter this week, we discuss algorithms that push machine learning into new realms and research that challenges how we think about intelligence. We're also changing up our production process a bit to improve overall readability. If you notice anything amiss, or have any questions, please don't hesitate to [drop us a line](mailto:clients@fastforwardlabs.com). Feedback is always appreciated!
