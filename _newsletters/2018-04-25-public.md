...
Hello! In this month's newsletter, we discuss active learning, neural network architectures for language modeling, a patent that uses machine learning to identify combinations of plant proteins, and TensorFlow.js.  We also celebrate the arrival of spring in New York City with some recommended (preferably outdoor) reading, including a few sci-fi stories from our new sci-fi site. 
...
and be sure to check out our new [SciFi site](https://scifi.fastforwardlabs.com/)!
