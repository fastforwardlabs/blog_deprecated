...
Hello! In this month's newsletter, we discuss active learning, neural network architectures for language modeling, and TensorFlow.js.  We also celebrate the arrival of spring in New York City with some recommended patio reading, including a few sci-fi stories from [our new sci-fi site](https://scifi.fastforwardlabs.com/)! 
