...
Hello! In this week's newsletter, we report on new open source tools for explaining machine learning model behavior, creative applications of machine learning in film, and recent advances in topic modeling of large-scale text data.  

We're also thrilled to announce availiability of our newest research report on multi-task learning.  You can learn more on our [BLOG](http://blog.fastforwardlabs.com/2018/06/26/supercharging-classification-the-value-of-multitask-learning.html) or watch a replay of our recent [WEBINAR](https://info.cloudera.com/LP=2027), and register to subscribe to the report [HERE](https://www.cloudera.com/products/fast-forward-labs-research/fast-forward-labs-research-reports.html).
...
We have a new post up on our blog!  [TODO: link]

And here are a couple of our other favorite finds:
