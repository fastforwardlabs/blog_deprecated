...
* [Federated Learning for Firefox](https://florian.github.io/federated-learning-firefox/) - federated learning (distributed learning that preserves privacy and minimizes communication costs) is the subject of our next report. There's lots of academic research, but this is the first article that goes into any technical depth about its production use in the Firefox web browser.
