...
<pre class="prettyprint lang-python">from cuckoofilter import CuckooFilter
c_filter = CuckooFilter(10000, 2) #specify capacity and fingerprint size
</pre><pre class="prettyprint lang-python">c_filter.insert("James")
...
</pre><pre class="prettyprint lang-python">from cuckoofilter import CountingBloomFilter
...
</pre><pre class="prettyprint lang-python">#obtain possibe indices
...
# [[], [], [], [], [], [], [], [], [], [b'\xc0\n']]
</pre><pre class="prettyprint lang-python">#let's insert "james" again. 
index_1, index_2, fp = obtain_indices_from_item("James", 2, 10)
