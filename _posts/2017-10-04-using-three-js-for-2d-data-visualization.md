...
If you have ideas on how to do this stuff better I'd love to hear them at
[@grantcuster](//www.twitter.com/GrantCuster).
...
position of the mouse and I want that zoom to feel smooth and responsive. I want the browser to
...
I'd also seen a bit of WebGL could do while working on our [Probabilistic Real
...
canvas rendering to its limits, rendering around TODO: 50,000 points. 
...
render TODO: 100,000 points without framerate issues. Coming (like me) from D3
...
for examples of 2D visualizations similar to what I was trying to do. There are
...
Rather than having logic set up to only redraw when things change, the animation
loop is always redrawing. Because of this, you don't have to worry about render
logic as you update objects (like the camera) in a three.js scene. You just
update. This resonates with philosophy of newer javascript frameworks like
...
it came to it I would do that, but it felt a little wrong.
...
points so the appear larger as you get closer and smaller as you move the camera
...
set-up I'm happy with has been more of a process. Targeted
...
trying to plugin [D3's zoom behavior](https://github.com/d3/d3-zoom), since I was most familiar with it, and I
...
I crashed my browser a lot during the zoom experiments, and sometimes crashed my
...
some developer tools profiling but wasn't really sure what to look for. Compared
...
always the case. I had my first tangle with a lot of the concepts and edges
of three.js that I expect I'll have lots of opportunities to revisit. I look 
forward to learning how to do all this stuff better in the future.
...
culling?
- The camera uses field of view which I is not at all intuitive to me but if you
...
seemed the right level for me to dive in at.
